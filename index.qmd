...
description: This notebook replicates the '_Source - TAZ & Regional Median Income - 2022-03-17.xlsb' tab from the 2024 Socioeconomic Projections Excel file. It calculates the median income for each Traffic Analysis Zone (TAZ) based on household income data and population data.
author:
 - name: Pukar Bhandari
