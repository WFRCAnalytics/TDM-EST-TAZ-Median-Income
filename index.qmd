...
gdf_TAZ = gpd.read_file(
  r"_data/TAZ/USTMv4_TAZ_20250729_WGS84.geojson"
).to_crs(PROJECT_CRS)
...
gdf_TAZ["CO_IDX"] = gdf_TAZ["CO_IDX"].astype(int)
...
# If HH > 0, use weighted mean; otherwise use simple mean
taz_aggregated['MedInc'] = np.where(
    taz_aggregated['HH23'] > 0,
